...
function set( value ) {
	...
	data = this._axisDataObjs[ 3 ].data;
	if ( !isNumberArray( value ) && !isEmptyArray( value ) ) {
		throw new TypeError( format( 'invalid assignment. `%s`array of number is expected. Value: `%s`.', 'axis-data', value ) );
	}
